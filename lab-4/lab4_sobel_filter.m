...
R_filtered_1 = edge(R, 'sobel', 'horizontal');
G_filtered_1 = edge(G, 'sobel', 'horizontal');
B_filtered_1 = edge(B, 'sobel', 'horizontal');
...
R_filtered_2 = edge(R, 'sobel', 'vertical');
G_filtered_2 = edge(G, 'sobel', 'vertical');
B_filtered_2 = edge(B, 'sobel', 'vertical');
